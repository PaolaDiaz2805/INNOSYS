...
<body>
     <form action="editarver.php" method="post" novalidate>
    <h1>LOS DATOS DE TU CLASE</h1>
    <h2>Llena el formulario</h2>
    <label for="nom">NOMBRE</label><br>
    <input type="text" id="nom" name="c1" value=<?=$nombre?> /><br>
    <input type="text" name="c2" value=<?=$codigo?>
