<?php 
    ...
    $sql2="UPDATE informacion SET ci='$ci', nombre='$nombre', apellido='$apellido', direccion='$direccion', fechadenacimiento='$fechadenacimiento', telefono='$telefono', rude='$rude' WHERE ci='$ci'";
